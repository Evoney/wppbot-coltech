...
class wppbot:
    ...
    def menu(self, nome_contato):
        ...
        self.caixa_de_mensagem = self.driver.find_element_by_class_name("_3u328")
        self.caixa_de_mensagem.send_keys(nome_contato + ", durante nossa conversa, escolha e digite um número ou opção por vez para dar continuidade ao atendimento: ")
    ...
    def quemSomos(self):
        img = self.dir_path + '/quemSomos.png'
        self.driver.find_element_by_css_selector('span[data-icon="clip"]').click()
        attach = self.driver.find_element_by_css_selector('input[type="file"]')
        attach.send_keys(img)
        time.sleep(2)
    ...
    def servicos(self):
        servicos = self.dir_path + '/Carta de Serviços.pdf'
        self.driver.find_element_by_css_selector('span[data-icon="clip"]').click()
        attach = self.driver.find_element_by_css_selector('input[type="file"]')
