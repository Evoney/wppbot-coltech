        ...
        while i < tamanho:
            ...
            if (clicou == True):
                ...
                while (j < len(mensagens)):
                    ...
                    if (('_2ugFP' in tipo_ultima_mensagem_2 in tipo_ultima_mensagem_2) and 'message-out' in tipo_ultima_mensagem):
                ...
                dia_atual, mes_atual = data_em_texto.split('/')
                ...
                if(tem_nova_mensagem == True):
                    ...
                    if (cliente_esperando_atendimento_humano  == False):
                        ...
                        if (mensagem != None):
                            ...
                            mensagens = bot.driver.find_elements_by_class_name("-N6Gq")
                            if (len(mensagens) > 2):
                                penultima_mensagem = len(mensagens) - 2
                                penultima_mensagem = mensagens[penultima_mensagem].find_element_by_class_name("_12pGw").get_attribute('innerText')
